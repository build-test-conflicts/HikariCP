...
public class ConnectionStateTest {
  @Test public void testAutoCommit() throws SQLException {
  ...
  @Test public void testCatalog() throws SQLException {
    HikariDataSource ds=new HikariDataSource();
    ds.setCatalog("test");
    ds.setMinimumIdle(1);
    ds.setMaximumPoolSize(1);
  ...
  @Test public void testCommitTracking() throws SQLException {
    HikariDataSource ds=new HikariDataSource();

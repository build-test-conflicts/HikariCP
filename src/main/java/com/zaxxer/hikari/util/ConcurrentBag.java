 ...
 */
@SuppressWarnings("rawtypes") public class ConcurrentBag<T extends IConcurrentBagEntry> implements AutoCloseable {
  private static Logger LOGGER=LoggerFactory.getLogger(ConcurrentBag.class);
  private QueuedSequenceSynchronizer synchronizer;
  private CopyOnWriteArrayList<T> sharedList;
  private boolean weakThreadLocals;
  private ThreadLocal<List> threadList;
 ...
 */
  @SuppressWarnings("unchecked") public T borrow(  long timeout,  final TimeUnit timeUnit) throws InterruptedException {
 ...
 */
  @SuppressWarnings("unchecked") public void requite(  final T bagEntry){
 ...
 */
  ...
  /** 
 * Remove a value from the bag.  This method should only be called with objects obtained by <code>borrow(long, TimeUnit)</code> or <code>reserve(T)</code>
 * @param bagEntry the value to remove
 * @return true if the entry was removed, false otherwise
 * @throws IllegalStateException if an attempt is made to remove an objectfrom the bag that was not borrowed or reserved first
 */
 ...
 */
  ...
  /** 
 * This method provides a "snapshot" in time of the BagEntry items in the bag in the specified state.  It does not "lock" or reserve items in any way.  Call <code>reserve(T)</code> on items in list before performing any action on them.
 ...
 */
  ...
  /** 
 * This method provides a "snapshot" in time of the bag items.  It does not "lock" or reserve items in any way.  Call <code>reserve(T)</code> on items in the list, or understand the concurrency implications of modifying items, before performing any action on them.
 * @return a possibly empty list of (all) bag items
 */
  @SuppressWarnings("unchecked") public List<T> values(){
    return (List<T>)sharedList.clone();
  }
  /** 
 * The method is used to make an item in the bag "unavailable" for borrowing.  It is primarily used when wanting to operate on items returned by the <code>values(int)</code> method.  Items that are reserved can be removed from the bag via <code>remove(T)</code> without the need to unreserve them.  Items that are not removed from the bag can be make available for borrowing again by calling the <code>unreserve(T)</code> method.
 ...
 */
  ...
  /** 
 * This method is used to make an item reserved via <code>reserve(T)</code> available again for borrowing.
 ...
 */
  ...
  /** 
 * Determine whether to use WeakReferences based on whether there is a custom ClassLoader implementation sitting between this class and the System ClassLoader.

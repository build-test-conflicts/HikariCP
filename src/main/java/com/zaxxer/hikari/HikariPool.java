...
public final class HikariPool implements HikariPoolMBean {
  private static Logger LOGGER=LoggerFactory.getLogger(HikariPool.class);
  DataSource dataSource;
  private IConnectionCustomizer connectionCustomizer;
  private HikariConfig configuration;
  private LinkedBlockingQueue<IHikariConnectionProxy> idleConnections;
  private Timer houseKeepingTimer;
  private long leakDetectionThreshold;
  private AtomicBoolean backgroundFillQueued;
  private AtomicInteger idleConnectionCount;
  private AtomicInteger totalConnections;
  private AtomicInteger awaitingConnection;
  private boolean isAutoCommit;
  private boolean jdbc4ConnectionTest;
  private boolean isRegisteredMbeans;
...
LOGGER.debug("{}Pool stats (total={}, inUse={}, avail={}, waiting={})",(prefix.length > 0 ? prefix[0] : ""),total,total - idle,idle,(isRegisteredMbeans ? awaitingConnection.get() : "n/a"));
}
/** 
...
private static enum AddConnectionStrategy {ONLY_IF_EMPTY, BACKGROUND_FILL, MAINTAIN_MINIMUM}
public HikariPool(){
}
}

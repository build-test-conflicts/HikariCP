...
public abstract class ConnectionProxy implements IHikariConnectionProxy {
  ...
  private FastList<Statement> statements;
  ...
  @Override public SQLException checkException(  final SQLException sqle){
    ...
    if (sqlState != null) {
      ...
      if (isForceClose) {
        ...
        LOGGER.warn("{} - Connection {} marked as broken because of SQLSTATE({}), ErrorCode({})",poolEntry.parentPool,poolEntry.connection,sqlState,sqle.getErrorCode(),sqle);
      }
 else {

...
public abstract class ProxyConnection implements Connection {
  static int DIRTY_BIT_READONLY=0b00001;
  static int DIRTY_BIT_AUTOCOMMIT=0b00010;
  static int DIRTY_BIT_ISOLATION=0b00100;
  static int DIRTY_BIT_CATALOG=0b01000;
  static int DIRTY_BIT_NETTIMEOUT=0b10000;
 ...
 * {@inheritDoc} 
 */
  public SQLException checkException(  final SQLException sqle){
 ...
 * {@inheritDoc} 
 */
  @Override public final void close() throws SQLException {
    closeStatements();
...
private static final class ClosedConnection {
    static Connection CLOSED_CONNECTION=getClosedConnection();

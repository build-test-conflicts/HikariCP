...
public final class PoolElf {
  private static Logger LOGGER=LoggerFactory.getLogger(PoolElf.class);
  private static String[] RESET_STATES={"readOnly","autoCommit","isolation","catalog","netTimeout"};
  ...
  private boolean isUseJdbc4Validation;
 ...
 */
public void setupConnection(final Connection connection,final long connectionTimeout) throws SQLException {
...
transactionIsolation=(transactionIsolation < 0 || defaultLevel == Connection.TRANSACTION_NONE) ? defaultLevel : transactionIsolation;
...
public void resetConnectionState(final PoolBagEntry poolEntry) throws SQLException {
int resetBits=0;
...
/** 
 * This will create a string for debug logging. Given a set of "reset bits", this method will return a concatenated string, for example: Input : 0b00110 Output: "autoCommit, isolation"  
